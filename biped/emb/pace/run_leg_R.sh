#!/usr/bin/env bash
# run_leg_R.sh — 오른다리(HR) 4축 마찰 측정. **오른다리는 작업자가 손으로 잡는다.**
#
...
#   나머지를 잡으면** 된다.
#
# 사용:  bash run_leg_R.sh            # 전체
#        bash run_leg_R.sh 3          # 특정 채널만
set -u
cd "$(dirname "$0")"
...
echo "════════════════════════════════════════════════════════════════"
echo " 오른다리(HR) 마찰 측정 — **왼다리를 손으로 잡아 주세요**"
echo "════════════════════════════════════════════════════════════════"
...
echo
echo "════════════════════════════════════════════════════════════════"
echo " 오른다리 완료. 리포트: results/output.html"
