...
#   ⇒ **왼쪽 무릎 벨트/풀리 미끄러짐.**
#
# ★★2026-08-25 재측정 (영점자세 home=0° · 축별 브래킷) — **thigh 좌우차의 정체 확정**:
...
export GRAV_SCALE_JOINT="1.20,1.25,1.00,1.00,1.18,1.05,1.00,1.00"
...
export STAND_TAU_SCALE_JOINT="1.20,1.25,1.00,1.00,1.18,1.05,1.00,1.00"
